...
// Imprime na tela o estado atual da rede (tensões complexas nodais em cada
// fase)
  ...
  for (i = 0; i < numeroBarras; i++) {
    ...
    case 1:
      printf("%d\tVa: %.5lf | %.3lf \tVb:    -    |    -   \tVc:    -    |    "
             "-   \n",
             grafo[i].barra->ID, cabs(grafo[i].V[0]),
             carg(grafo[i].V[0]) * 180 / PI);
      break;
    case 2:
      printf("%d\tVa:    -    |    -    \tVb: %.5lf | %.3lf\tVc:    -    |    "
             "-   \n",
             grafo[i].barra->ID, cabs(grafo[i].V[1]),
             carg(grafo[i].V[1]) * 180 / PI);
      break;
    case 3:
      printf("%d\tVa:    -    |    -    \tVb:    -    |    -   \tVc: %.5lf | "
             "%.3lf\n",
             grafo[i].barra->ID, cabs(grafo[i].V[0]), cabs(grafo[i].V[2]),
             carg(grafo[i].V[2]) * 180 / PI);
      break;
    case 4:
      printf(
          "%d\tVa: %.5lf | %.3lf \tVb: %.5lf | %.3lf\tVc:    -    |    -   \n",
          grafo[i].barra->ID, cabs(grafo[i].V[0]),
          carg(grafo[i].V[0]) * 180 / PI, cabs(grafo[i].V[1]),
          carg(grafo[i].V[1]) * 180 / PI);
      break;
    case 5:
      printf(
          "%d\tVa: %.5lf | %.3lf \tVb:    -    |    -   \tVc: %.5lf | %.3lf\n",
          grafo[i].barra->ID, cabs(grafo[i].V[0]),
          carg(grafo[i].V[0]) * 180 / PI, cabs(grafo[i].V[2]),
          carg(grafo[i].V[2]) * 180 / PI);
      break;
    case 6:
      printf(
          "%d\tVa:    -    |    -    \tVb: %.5lf | %.3lf\tVc: %.5lf | %.3lf\n",
          grafo[i].barra->ID, cabs(grafo[i].V[1]),
          carg(grafo[i].V[1]) * 180 / PI, cabs(grafo[i].V[2]),
          carg(grafo[i].V[2]) * 180 / PI);
      break;
    case 7:
...
void saidaEstado(GRAFO *grafo, long int numeroBarras, int it, double tempoIt,
                 double nFx, double nGx) {
  int i, j, k;
  ...
  for (i = 0; i < numeroBarras; i++) {
    ...
    case 3:
      fprintf(arquivo,
              "C\t%d\tVa:    -    |    -    \tVb:    -    |    -   \tVc: %.5lf "
              "| %.3lf\n",
              grafo[i].barra->ID, cabs(grafo[i].V[2]),
              carg(grafo[i].V[2]) * 180 / PI);
      break;
    case 4:
      fprintf(arquivo,
              "AB\t%d\tVa: %.5lf | %.3lf \tVb: %.5lf | %.3lf\tVc:    -    |    "
              "-   \n",
              grafo[i].barra->ID, cabs(grafo[i].V[0]),
              carg(grafo[i].V[0]) * 180 / PI, cabs(grafo[i].V[1]),
              carg(grafo[i].V[1]) * 180 / PI);
    ...
    case 7:
      fprintf(
          arquivo,
          "ABC\t%d\tVa: %.5lf | %.3lf \tVb: %.5lf | %.3lf\tVc: %.5lf | %.3lf\n",
          grafo[i].barra->ID, cabs(grafo[i].V[0]),
          carg(grafo[i].V[0]) * 180 / PI, cabs(grafo[i].V[1]),
          carg(grafo[i].V[1]) * 180 / PI, cabs(grafo[i].V[2]),
          carg(grafo[i].V[2]) * 180 / PI);
  ...
  for (i = 0; i < numeroBarras; i++) {
    ...
    case 5:
      fprintf(arquivo,
              "CA\t%d\tVab:   -   |   -  \tVbc:    -    |    -   \tVca: %.5lf "
              "| %.3lf\n",
              grafo[i].barra->ID, cabs(grafo[i].V[2] - grafo[i].V[0]),
              carg(grafo[i].V[2] - grafo[i].V[0]) * 180 / PI);
      break;
    case 6:
      fprintf(arquivo,
              "BC\t%d\tVab:    -    |    -    \tVbc: %.5lf | %.3lf\tVca:   -   "
              " |   -  \n",
              grafo[i].barra->ID, cabs(grafo[i].V[1] - grafo[i].V[2]),
              carg(grafo[i].V[1] - grafo[i].V[2]) * 180 / PI);
      break;
    case 7:
      fprintf(arquivo,
              "ABC\t%d\tVab: %.5lf | %.3lf \tVbc: %.5lf | %.3lf\tVca: %.5lf | "
              "%.3lf\n",
              grafo[i].barra->ID, cabs(grafo[i].V[0] - grafo[i].V[1]),
              carg(grafo[i].V[0] - grafo[i].V[1]) * 180 / PI,
    ...
    for (k = 0; k < grafo[i].numeroAdjacentes; k++) {
      ...
      case 1:
        fprintf(arquivo, "1,0,%d,%d,1,%.8lf,0.020000\n", grafo[i].barra->ID,
                grafo[grafo[i].adjacentes[k].idNo].barra->ID,
                (__real__ grafo[i].adjacentes[k].S[0]) * Sbase);
        break;
      case 2:
        fprintf(arquivo, "1,0,%d,%d,2,%.8lf,0.020000\n", grafo[i].barra->ID,
                grafo[grafo[i].adjacentes[k].idNo].barra->ID,
                (__real__ grafo[i].adjacentes[k].S[1]) * Sbase);
        break;
      case 3:
        fprintf(arquivo, "1,0,%d,%d,3,%.8lf,0.020000\n", grafo[i].barra->ID,
                grafo[grafo[i].adjacentes[k].idNo].barra->ID,
                (__real__ grafo[i].adjacentes[k].S[2]) * Sbase);
        break;
      case 4:
        fprintf(arquivo, "1,0,%d,%d,1,%.8lf,0.020000\n", grafo[i].barra->ID,
                grafo[grafo[i].adjacentes[k].idNo].barra->ID,
    ...
    for (k = 0; k < grafo[i].numeroAdjacentes; k++) {
      ...
      case 1:
        fprintf(arquivo, "1,1,%d,%d,1,%.8lf,0.020000\n", grafo[i].barra->ID,
                grafo[grafo[i].adjacentes[k].idNo].barra->ID,
                (__imag__ grafo[i].adjacentes[k].S[0]) * Sbase);
        break;
      case 2:
        fprintf(arquivo, "1,1,%d,%d,2,%.8lf,0.020000\n", grafo[i].barra->ID,
                grafo[grafo[i].adjacentes[k].idNo].barra->ID,
                (__imag__ grafo[i].adjacentes[k].S[1]) * Sbase);
        break;
      case 3:
        fprintf(arquivo, "1,1,%d,%d,3,%.8lf,0.020000\n", grafo[i].barra->ID,
                grafo[grafo[i].adjacentes[k].idNo].barra->ID,
                (__imag__ grafo[i].adjacentes[k].S[2]) * Sbase);
        break;
      case 4:
        fprintf(arquivo, "1,1,%d,%d,1,%.8lf,0.020000\n", grafo[i].barra->ID,
                grafo[grafo[i].adjacentes[k].idNo].barra->ID,
  ...
  for (i = 0; i < numeroBarras; i++) {
    ...
    case 1:
      fprintf(arquivo, "1,2,%d,-1,1,%.8lf,0.020000\n", grafo[i].barra->ID,
              (__real__ grafo[i].S[0]) * Sbase);
      break;
    case 2:
      fprintf(arquivo, "1,2,%d,-1,2,%.8lf,0.020000\n", grafo[i].barra->ID,
              (__real__ grafo[i].S[1]) * Sbase);
      break;
    case 3:
      fprintf(arquivo, "1,2,%d,-1,3,%.8lf,0.020000\n", grafo[i].barra->ID,
              (__real__ grafo[i].S[2]) * Sbase);
      break;
    case 4:
      fprintf(arquivo, "1,2,%d,-1,1,%.8lf,0.020000\n", grafo[i].barra->ID,
              (__real__ grafo[i].S[0]) * Sbase);
  ...
  for (i = 0; i < numeroBarras; i++) {
    ...
    case 1:
      fprintf(arquivo, "1,3,%d,-1,1,%.8lf,0.020000\n", grafo[i].barra->ID,
              (__imag__ grafo[i].S[0]) * Sbase);
      break;
    case 2:
      fprintf(arquivo, "1,3,%d,-1,2,%.8lf,0.020000\n", grafo[i].barra->ID,
              (__imag__ grafo[i].S[1]) * Sbase);
      break;
    case 3:
      fprintf(arquivo, "1,3,%d,-1,3,%.8lf,0.020000\n", grafo[i].barra->ID,
              (__imag__ grafo[i].S[2]) * Sbase);
      break;
    case 4:
      fprintf(arquivo, "1,3,%d,-1,1,%.8lf,0.020000\n", grafo[i].barra->ID,
              (__imag__ grafo[i].S[0]) * Sbase);
  ...
  for (i = 0; i < numeroBarras; i++) {
    ...
    case 1:
      fprintf(arquivo, "1,4,%d,-1,1,%.8lf,0.010000\n", grafo[i].barra->ID,
              grafo[i].Vbase / 1000 * cabs(grafo[i].V[0]));
      break;
    case 2:
      fprintf(arquivo, "1,4,%d,-1,2,%.8lf,0.010000\n", grafo[i].barra->ID,
              grafo[i].Vbase / 1000 * cabs(grafo[i].V[1]));
      break;
    case 3:
      fprintf(arquivo, "1,4,%d,-1,3,%.8lf,0.010000\n", grafo[i].barra->ID,
              grafo[i].Vbase / 1000 * cabs(grafo[i].V[2]));
      break;
    case 4:
      fprintf(arquivo, "1,4,%d,-1,1,%.8lf,0.010000\n", grafo[i].barra->ID,
              grafo[i].Vbase / 1000 * cabs(grafo[i].V[0]));
...
// Exporta arquivo de texto com as informações da distribuição a Priori SCADA
void exportaPrioriQR(GRAFO *grafo, double *regua, DMED *medidas, long int nvar,
                     long int nmed, long int polar) {
  int i, j, k, r, fase;
  ...
  if (polar == 1) {
    ...
    for (i = 0; i < nvar; i++) {
      for (j = i; j < nvar; j++) {
        if (fabs(R[i][j]) >= 0.0000001)
          fprintf(priori, "%d\t%d\t%.14f\n", i, j, R[i][j]);
      }
    }
  } else {
    for (i = 0; i < nvar; i++) {
    ...
    // Montar matriz G em coordenadas retangulares ou fazer rotação da matriz -
    // Motada a matriz H em retangulares
    //        for(i=0;i<nvar;i++){
    //            fprintf(priori,"\n");
    //            for(j=i;j<nvar;j++){
    //                fprintf(priori,"%.14f\t",R[i][j]);
...
void monta_z_comVirtuais(double *z, long int nmed, long int nvir, DMED *medidas,
                         DMED *virtuais) {
  int i;
  for (i = 0; i < nmed; i++) {
    z[i] = medidas[i].zmed;
...
void monta_W(double **W, long int nmed, DMED *medidas) {
  ...
  for (i = 0; i < nmed; i++) {
    ...
    case 7:
      ...
      prec =
          medidas[i]
              .prec; // 0.001; //0.1% para PMU de ângulo de tensão ou corrente
      break;
    case 8:
    case 9:
    case 10:
    ...
    // medidas[i].sigma = 0.33333*prec*cabs(medidas[i].zmed); //Ponderação de
    // acordo com o valor medido (Fórmula B. Pal)
  ...
  for (i = 0; i < nmed;
       i++) { // Tratamento da medida virtual e medidas proximo de zero
    if (cabs(medidas[i].zmed) < 0.00001) {
...
void incializa_vetor_x(GRAFO *grafo, long int numeroBarras,
                       ALIMENTADOR *alimentadores, long int numeroAlimentadores,
                       double *x, double *regua, long int nVariaveis) {
  int i, k, fase;
  ...
  // Flat start trifásico (Va = Vb = Vc = 1p.u.  Ta = 0  Tb = -120  Tc = 120) -
  // com busca em profundidade para atualizar taps iniciais
  for (i = 0; i < numeroBarras; i++) {
    visitado[i] = false;
  }
  for (i = 0; i < numeroAlimentadores; i++) {
    // Tensão Inicial da subestação
    V0[0] = grafo[alimentadores[i].noRaiz]
                .barra->Vinicial[0]; // 1.0*(cos(0) + I*sin(0));
    V0[1] =
        grafo[alimentadores[i].noRaiz]
            .barra->Vinicial[1]; // 1.0*(cos(-120*PI/180) + I*sin(-120*PI/180));
    V0[2] =
        grafo[alimentadores[i].noRaiz]
            .barra->Vinicial[2]; // 1.0*(cos(120*PI/180) + I*sin(120*PI/180));
    ...
    //            grafo[i].V[0] =
    //            cabs(grafo[alimentadores[idAlim].noRaiz].V[0])*(cos(-30*PI/180)
    //            + I*sin(-30*PI/180)); grafo[i].V[1] =
    //            cabs(grafo[alimentadores[idAlim].noRaiz].V[1])*(cos(-150*PI/180)
    //            + I*sin(-150*PI/180)); grafo[i].V[2] =
    //            cabs(grafo[alimentadores[idAlim].noRaiz].V[2])*(cos(90*PI/180)
    //            + I*sin(90*PI/180));
    //
    ////            grafo[para].V[0] = cabs(grafo[de].V[0])*(cos(-30*PI/180) +
    ///I*sin(-30*PI/180)); /            grafo[para].V[1] =
    ///cabs(grafo[de].V[1])*(cos(-150*PI/180) + I*sin(-150*PI/180)); /
    ///grafo[para].V[2g] = cabs(grafo[de].V[2])*(cos(90*PI/180) +
    ///I*sin(90*PI/180));
    //        }
    //
    //    }
    ...
    while (barraAtual != NULL) {
      ...
      for (k = 0; k < n_adj; k++) {
        ...
        if (visitado[para] == false) {
          if ((grafo[de].adjacentes[k].tipo ==
               1)) { // Atualiza o V0 para trafo visto a ligação e tap
            grafo[para].V[0] = grafo[de].V[0];
            grafo[para].V[1] = grafo[de].V[1];
            grafo[para].V[2] = grafo[de].V[2];

            if ((grafo[de].adjacentes[k].ramo->trafo.lig_pri == 1) &&
                (grafo[de].adjacentes[k].ramo->trafo.lig_sec == 2)) {
              grafo[para].V[0] =
                  cabs(grafo[de].V[0]) *
                  (cos(-30 * PI / 180) + I * sin(-30 * PI / 180));
              grafo[para].V[1] =
                  cabs(grafo[de].V[1]) *
                  (cos(-150 * PI / 180) + I * sin(-150 * PI / 180));
              grafo[para].V[2] = cabs(grafo[de].V[2]) *
                                 (cos(90 * PI / 180) + I * sin(90 * PI / 180));
            } else if ((grafo[de].adjacentes[k].ramo->trafo.lig_pri == 3) &&
                       (grafo[de].adjacentes[k].ramo->trafo.lig_sec == 2)) {
              grafo[para].V[0] =
                  cabs(grafo[de].V[0]) *
                  (cos(-30 * PI / 180) + I * sin(-30 * PI / 180));
              ...
              grafo[para].V[2] = cabs(grafo[de].V[2]) *
                                 (cos(90 * PI / 180) + I * sin(90 * PI / 180));
            } else if ((grafo[de].adjacentes[k].ramo->trafo.lig_pri == 2) &&
                       (grafo[de].adjacentes[k].ramo->trafo.lig_sec == 1)) {
              if (grafo[de].adjacentes[k].ramo->k == de) {
                ...
                grafo[para].V[0] = cabs(grafo[de].V[0]) *
                                   (cos(0 * PI / 180) + I * sin(0 * PI / 180));
                grafo[para].V[1] =
                    cabs(grafo[de].V[1]) *
                    (cos(-120 * PI / 180) + I * sin(-120 * PI / 180));
                grafo[para].V[2] =
                    cabs(grafo[de].V[2]) *
                    (cos(120 * PI / 180) + I * sin(120 * PI / 180));
              }
          ...
          } else if (grafo[de].adjacentes[k].tipo ==
                     2) { // Para o caso de regulador de tensão
            grafo[para].V[0] = grafo[de].V[0] *
                               grafo[de].adjacentes[k].ramo->tap_pri[0] *
                               grafo[de].adjacentes[k].ramo->tap_sec[0];
            grafo[para].V[1] = grafo[de].V[1] *
                               grafo[de].adjacentes[k].ramo->tap_pri[1] *
                               grafo[de].adjacentes[k].ramo->tap_sec[1];
            grafo[para].V[2] = grafo[de].V[2] *
                               grafo[de].adjacentes[k].ramo->tap_pri[2] *
                               grafo[de].adjacentes[k].ramo->tap_sec[2];
          } else {
            grafo[para].V[0] = grafo[de].V[0];
            grafo[para].V[1] = grafo[de].V[1];
            grafo[para].V[2] = grafo[de].V[2];
  ...
  for (i = 0; i < nVariaveis; i++) {
    ...
    if (regua[i] > 0) { // magnitude de tensão
      x[i] = cabs(
          grafo[k].V[fase]); // mantém o ângulo anterior e altera a magnitude
  ...
  for (i = 0; i < numeroBarras; i++) {
    ...
    for (k = 0; k < grafo[i].numeroAdjacentes; k++) {
      if (i == grafo[i].adjacentes[k].ramo->k) {
        Skm(&grafo[i], &grafo[grafo[i].adjacentes[k].idNo],
            grafo[i].adjacentes[k].ramo, Saux);
        Ikm(&grafo[i], &grafo[grafo[i].adjacentes[k].idNo],
            grafo[i].adjacentes[k].ramo, Iaux);
      } else {
        Smk(&grafo[grafo[i].adjacentes[k].idNo], &grafo[i],
            grafo[i].adjacentes[k].ramo, Saux);
        Imk(&grafo[grafo[i].adjacentes[k].idNo], &grafo[i],
            grafo[i].adjacentes[k].ramo, Iaux);
      }
...
void atualiza_Modelo(GRAFO *grafo, long int numeroBarras, long int nmed,
                     DMED *medidas) {
  int i, j, k, idMed, de, para, ramo, fase;
  __complex__ double *Saux, *Iaux;
  BOOL visitado[numeroBarras];
  ...
  for (idMed = 0; idMed < nmed; idMed++) {
    if (medidas[idMed].PARA == -1) { // Medidor instalado em uma barra
      i = medidas[idMed].k;
      fase = medidas[idMed].fases -
             1; // Revisar para trifásico genérico - atual somente A ou B ou C -
                // medida no Delta por exemplo
      ...
      case 5: // 5: Ângulo de Tensão - graus
        ...
        break;
      case 8: // 8: Injeção Magnitude de Corrente - A  //REVISAR A MEDIDA DE
              // INJEÇÂO DE PMU NO ESTIMADOR HIBRIDO
...
void atualiza_h(GRAFO *grafo, long int numeroBarras, long int nmed,
  ...
  for (i = 0; i < numeroBarras; i++) {
    ...
    for (j = 0; j < grafo[i].nmed; j++) {
      ...
      fase = grafo[i].medidores[j]->fases -
             1; // Revisar para trifásico genérico - atual somente A ou B ou C
    ...
    for (k = 0; k < grafo[i].numeroAdjacentes; k++) {
      ...
      for (j = 0; j < grafo[i].adjacentes[k].nmed; j++) {
        ...
        fase = grafo[i].adjacentes[k].medidores[j]->fases -
               1; // Revisar para trifásico genérico - atual somente A ou B ou C
...
void atualiza_H(GRAFO *grafo, long int numeroBarras, DRAM *ramos, DMED *medidas,
      ...
      for (j = 0; j < medidas[i].nvar; j++) {
        ...
        if (medidas[i].reguaH[j] >= 0) {
          if (medidas[i].fases - 1 == fase)
            medidas[i].H[j] =
                __real__ grafo[k].V[fase] / cabs(grafo[k].V[fase]);
        } else {
          k = -k;
          if (medidas[i].fases - 1 == fase)
            medidas[i].H[j] =
                __imag__ grafo[k].V[fase] / cabs(grafo[k].V[fase]);
        }
      }
      break;
    case 5: // 5: Magnitude de tensão
      for (j = 0; j < medidas[i].nvar; j++) {
        ...
        if (medidas[i].reguaH[j] >= 0) {
          if (medidas[i].fases - 1 == fase)
            medidas[i].H[j] =
                -1 * __imag__ grafo[k].V[fase] /
                pow(__real__ grafo[k].V[fase], 2) * 1 /
                (1 +
                 pow(__imag__ grafo[k].V[fase] / __real__ grafo[k].V[fase], 2));
        } else {
          k = -k;
          if (medidas[i].fases - 1 == fase)
            medidas[i].H[j] =
                1 / __real__ grafo[k].V[fase] * 1 /
                (1 +
                 pow(__imag__ grafo[k].V[fase] / __real__ grafo[k].V[fase], 2));
        }
      }
...
void atualiza_estado(GRAFO *grafo, double *x, double *regua,
                     long int nVariaveis) {
  int i, k, fase;

  // nVariaveis é o tamanho do vetor x
  // regua salva a respectiva barra e fase de cada elemento do vetor x (+ é
  // magnitude de tensão e - é ângulo)
  ...
  for (i = 0; i < nVariaveis; i++) {
    ...
    if (regua[i] > 0) { // magnitude de tensão
      grafo[k].V[fase] =
          x[i] * grafo[k].V[fase] /
          cabs(grafo[k]
                   .V[fase]); // mantém o ângulo anterior e altera a magnitude
    } else {                  // ângulo de tensão
      fase = fase;
      k = -k;
      grafo[k].V[fase] =
          cabs(grafo[k].V[fase]) *
          (cos(x[i]) + I * sin(x[i])); // mantém a magnitude e altera o ângulo
    }
  }
}

// Tratamento da referência (por alimentador)
void tratamento_referencia(long int *ref_1, long int *ref_2,
                           ALIMENTADOR *alimentador, double *regua,
                           long int nVariaveis) {
  int i, j, k, n_ref = 3;
...
//
//------------------------------------------------------------------------------
void estimadorWLS(GRAFO *grafo, long int numeroBarras, DMED *medidas,
                  long int **numeroMedidas, ALIMENTADOR *alimentadores,
                  long int numeroAlimentadores, DRAM *ramos, double Sbase) {
  long int nmed, nvar;
  int i, j, k, r;
  ...
  incializa_vetor_x(grafo, numeroBarras, alimentadores, numeroAlimentadores, x,
                    regua, nvar);
  //    incializa_vetor_x_leitura(grafo, numeroBarras, alimentadores,
  //    numeroAlimentadores,x,regua,nvar); //Função que le de arquivo externo a
  //    condição inicial

  double tol = 0.000001;
  clock_t tIni = clock();
  int conv =
      otimiza_Gauss_NewtonQR(z, h, H, grafo, numeroBarras, ramos, medidas, nvar,
                             nmed, regua, x, tol, ref_1, ref_2);
  //    int conv = otimiza_Gauss_Newton_sparsePCGLS(z, h, H, W, grafo,
  //    numeroBarras, ramos, medidas, nvar - 3, nmed, regua, x, tol, ref_1,
  //    ref_2);
...
//------------------------------------------------------------------------------
//
// ESTIMADOR WLS CONVENCIONAL VIA WLS com restrições de Igualdade para virtuais
// e formulação esparsa do resíduo
//
//------------------------------------------------------------------------------
void estimadorWLShachtel(GRAFO *grafo, long int numeroBarras, DMED *medidas,
                         long int **numeroMedidas, DMED *virtuais,
                         long int **numeroVirtuais, ALIMENTADOR *alimentadores,
                         long int numeroAlimentadores, DRAM *ramos) {
  ...
  if ((c = malloc((nvir) * sizeof(double *))) == NULL) {
    printf(
        "Erro -- Nao foi possivel alocar espaco de memoria para o vetor c!!!!");
    exit(1);
  }
  ...
  // incializa_vetor_x(grafo, numeroBarras, alimentadores,
  // numeroAlimentadores,x,regua,nvar);
  incializa_vetor_x_leitura(
      grafo, numeroBarras, alimentadores, numeroAlimentadores, x, regua,
      nvar); // Função que le de arquivo externo a condição inicial
  ...
  double tol = 0.00001;
  clock_t tIni = clock();
  int conv = otimiza_Gauss_Newton_sparseHachtel_Virtuais(
      z, h, c, W, grafo, numeroBarras, ramos, medidas, virtuais, nvar - 3, nmed,
      nvir, regua, x, tol, ref_1, ref_2);
  clock_t t1 = clock();
  double tempoWLS = (double)(t1 - tIni) / CLOCKS_PER_SEC;
  printf("\nEstimação WLS: %lf", tempoWLS);
  printf("\nTensoes Nodais (p.u.):\n");
...
//
//------------------------------------------------------------------------------
void fluxoPotencia_NRQR(GRAFO *grafo, long int numeroBarras, DMED *medidas,
                        long int **numeroMedidas, ALIMENTADOR *alimentadores,
                        long int numeroAlimentadores, DRAM *ramos,
                        double Sbase) {
  long int nmed, nvar;
  ...
  printf(
      "Calculo de Fluxo de Potencia via Minimizacao de Residuo via NR-QR...\n");
  //--------------------------------------------------------------------------
  // Alocação de memória das variáveis do estimador de estado
  nmed = 0;
  for (i = 0; i < 9; i++) {
  ...
  monta_z(z, nmed, medidas); // para o fluxo somente valores das barras PQ, PV e
                             // VTeta devem compor o vetor de medidas
  monta_W_Ident(NULL, nmed, medidas);
  ...
  clock_t tIni = clock();
  int conv =
      otimiza_Gauss_NewtonQR(z, h, H, grafo, numeroBarras, ramos, medidas,
                             nvar - 3, nmed, regua, x, tol, ref_1, ref_2);
...
void estimadorNEC(GRAFO *grafo, long int numeroBarras, DMED *medidas,
                  DMED *virtuais, long int **numeroMedidas,
                  long int **numeroVirtuais, ALIMENTADOR *alimentadores,
                  long int numeroAlimentadores, DRAM *ramos, double Sbase) {
  long int nmed, nvar, nvir;
  int i, j, k, r;
  double *z = NULL, **h = NULL, ***H = NULL, ***C = NULL, **W = NULL, *x = NULL,
         *regua = NULL, aux = 0;
  ...
  clock_t tIni = clock();
  int conv =
      otimizaNEC(z, h, H, C, grafo, numeroBarras, ramos, medidas, virtuais,
                 nvir, nvar, nmed, regua, x, tol, ref_1, ref_2);
  clock_t t1 = clock();
  double tempoWLS = (double)(t1 - tIni) / CLOCKS_PER_SEC;
...
void estimadorHatchel(GRAFO *grafo, long int numeroBarras, DMED *medidas,
                      DMED *virtuais, long int **numeroMedidas,
                      long int **numeroVirtuais, ALIMENTADOR *alimentadores,
                      long int numeroAlimentadores, DRAM *ramos, double Sbase) {
  long int nmed, nvar, nvir;
  ...
  clock_t tIni = clock();
  int conv =
      otimizaHatchel(z, h, H, C, grafo, numeroBarras, ramos, medidas, virtuais,
                     nvir, nvar, nmed, regua, x, tol, ref_1, ref_2);
  clock_t t1 = clock();
  double tempoWLS = (double)(t1 - tIni) / CLOCKS_PER_SEC;
