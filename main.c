...
int main(int argc, char **argv)
{
    ...
    for (int i = 0;i<100;i++) estimadorBayesFusion_MAP(grafo, numeroBarras, medida, numeroMedidas, alimentador, numeroAlimentadores, ramo, Sbase / 1000);
    ...
    free_MEDIDAS(medida,numeroMedidas);
