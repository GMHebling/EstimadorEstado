...
int main(int argc, char **argv) {
  ...
  long int **numeroMedidas = NULL, **numeroMedidasPMU = NULL,
           **numeroVirtuais = NULL;
  // long int i = 0;
  ...
  folder = leituraDados(&barra, &ramo, &numeroBarras, &numeroRamos,
                        &numeroAlimentadores);
  printf("leituraDados ok\n");
  // Melhorar o tratamento dos taps de reguladores e trafos - leitura separa de
  // estados lógicos
  ...
  buscaProfundidadeAlimentadores(grafo, numeroBarras, &alimentador,
                                 numeroAlimentadores);
  ...
  // Leitura das Medidas e associa os medidores ao grafo da rede - Numero de
  // medidas retorna matriz tipo de media/por fase Leitura das Medidas e associa
  // os medidores ao grafo da rede - Numero de medidas retorna matriz tipo de
  // media/por fase
  numeroMedidas = leituraMedidas(folder, "DMED.csv", &medida, ramo, numeroRamos,
                                 barra, numeroBarras, grafo,
                                 Sbase); // Melhorar o tratamento de chaves

  // estimadorWLS(grafo, numeroBarras, medida, numeroMedidas, alimentador,
  // numeroAlimentadores, ramo, Sbase / 1000);
  clock_t tIni = clock();

  // constroi o caminho do no raiz ate cada barra

  // estimadorBC_RECT(grafo, numeroRamos, numeroBarras, medida, numeroMedidas,
  // alimentador, numeroAlimentadores, ramo, Sbase / 1000, barra);

  estimadorAMB(grafo, numeroRamos, numeroBarras, medida, numeroMedidas,
               alimentador, numeroAlimentadores, ramo, Sbase / 1000, barra);
  clock_t t1 = clock();
  ...
  //    salvaDadosRedeEletrica(barra, numeroBarras, ramo, numeroRamos, medida,
  //    numeroMedidas);
  free(barra);
  free(ramo);
  free(grafo);
